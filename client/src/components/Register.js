...
import { ChefHat, Utensils, Mail, Lock, User, Eye, EyeOff, UserCheck } from 'lucide-react';
    ...
    <div className="modern-login-container">
      ...
      <div className="login-content-wrapper">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="modern-register-card"
        >
          {/* Header */}
          <motion.div
            custom={1}
          ...
          >
            ...
            <h2 className="login-title">Join Our Restaurant</h2>
            <p className="login-subtitle">Create your restaurant account</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="modern-register-form">
            ...
            {success && (
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                className="success-message modern-success"
              >
                {success}
              </motion.div>
            )}
            ...
            >
              ...
              <div className="modern-form-group">
                <label htmlFor="role" className="modern-label">Role</label>
                <div className="input-wrapper">
